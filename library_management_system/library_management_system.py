...
library.add_book("The Story of Life", "Sudha Murthy")
library.add_book("The Alchemist", "Paulo Coelho")
library.add_book("The Monk Who Sold His Ferrari", "Robin Sharma")

library.register_patron("Pavanraj")
library.register_patron("Sanjana")

library.borrow_book("Pavanraj", "The Story of Life")

library.show_books()
library.show_patrons()

library.return_book("Pavanraj", "The Story of Life")
